...
from pg_engine.core import TLoader, TScript

logger = logging.getLogger(__name__)


class ScriptLoader(TLoader):

    """Specialized loader for loading external (non engine) script files."""

    def load(self) -> dict[str, TScript]:
        """
        ...
        :rtype: dict[str, TScript]
        """  # noqa: E501
        loaded: dict[str, TScript] = {}
    ...
    @classmethod
    def export_module(cls, module: ModuleType) -> list[tuple[str, TScript]]:
        """
        Load all exportable :class:`TScript` classes from file or module.
        ...
        for entry in module_all:
            ...
            if (
                ...
                or not issubclass(module_entry, TScript)
            ):
                continue
